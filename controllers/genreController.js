...
// The page should display the genre name, 
// and a list of all books in the genre (each linked to the book's detail page)
...
exports.genre_delete_post = function(req, res, next) {
    ...
    async.parallel({
        ...
        if (results.genre_books>0) {
            res.render('genre_delete', { title: 'Delete Genre', genre: results.genre, genre_books: results.genre_books });            return;
        }
        else {
